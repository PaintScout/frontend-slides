...
<html lang="en">
  <head>
    ...
    <!-- crossorigin="anonymous" is required for dom-to-pptx to read font data -->
    <link rel="stylesheet" href="https://api.fontshare.com/v2/css?f[]=..." crossorigin="anonymous" />

    <!-- PPTX export: converts .slide elements to an editable .pptx file, client-side, no server needed -->
  ...
  <body>
    ...
    <!-- PPTX export button — fixed bottom-right, matches nav dots aesthetic -->
    <button id="pptx-export" title="Export to PowerPoint" style="
        ...
        backdrop-filter: blur(4px); transition: background 0.2s, color 0.2s;
    " onmouseover="this.style.background='rgba(255,255,255,0.3)';this.style.color='#fff'"
       onmouseout="this.style.background='rgba(255,255,255,0.15)';this.style.color='rgba(255,255,255,0.7)'"
       onclick="domToPptx.exportToPptx(Array.from(document.querySelectorAll('.slide')),{fileName:'deck.pptx',svgAsVector:true})">
        ⬇
    </button>
